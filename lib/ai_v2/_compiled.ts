...
//
// Generated: 2026-06-08T01:26:10.042Z
// ═══════════════════════════════════════════════════════════════
...
أحيانًا يصلك **حدثٌ داخليّ**: نشأ نقصٌ بغياب طبيب، ومعه حقائقه وحلوله لكلّ مكان.
**ابدأ أنت الحديث** كأنّك لاحظتَ النقص بنفسك — لا تقل إنّ أحدًا أعطاك إيّاه:
- اذكر **اليوم وأماكن النقص فقط**: عيادة برقمها، و**الدليقيتر** إن كان فيه نقص. **بلا
  فترات** إطلاقًا.
...
- اختم بسؤالٍ مفتوح: ماذا يريد؟ والقائد يردّ كتابةً.
- عند ردّه نفّذ بالأداة المناسبة (لا تذكر فترةً ولا تستعمل \`place_in_clinic\`):
